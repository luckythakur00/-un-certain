...
const founderDetails = [
    ...
    { name: "Sagrika Kukreja", description: "Sagrika is a Psychology graduate from the University of Delhi and holds a Master’s in HR & Organisational Analysis from King’s College London. Her background in behavioural science helps her understand how students think, cope, and respond to pressure — and how the right kind of support, offered early, can build lasting confidence. Having studied and worked across different systems and cultures, she brings a balanced, practical lens to mentorship — one that’s empathetic but clear, structured but flexible. At (un)certain, Sagrika helps students make sense of moments that feel overwhelming — from academic transitions to personal uncertainty. Her goal isn’t just better performance in class, but deeper self-awareness and direction.", Image: founder2 },
