...
const Contact = () => {
  ...
  return (
    <footer id='contact' className="bg-red-800 text-white font-sans p-8 md:p-12 lg:p-16">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="lg:col-span-1">
          <div className="text-2xl font-bold mb-6">
            <img src={logo} alt="Logo" className='h-12 w-60' />
          </div>
          <h2 className="text-4xl lg:text-5xl font-light leading-tight">Join The<br />Community!</h2>
          <button className="mt-6 border border-white px-6 py-2 hover:bg-white hover:text-red-800 transition-colors duration-300 rounded">Get in touch!</button>
        </div>
        <div>
