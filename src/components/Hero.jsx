      ...
      <div className='w-full'>
        ...
        <div className='w-full flex flex-col lg:flex-row'>
          <div className='w-full lg:w-1/2 min-h-[40vh] lg:min-h-[85vh] p-8 sm:p-12 lg:p-16 flex flex-col justify-center space-y-8 lg:space-y-10 bg-white text-[#8B0000] order-2 lg:order-1'>
            ...
            {/* <p className='text-base md:text-lg text-[#8B0000]'>At <strong>(un)<span className='text-[#2A2E31] font-semibold'>certain</span></strong>, we believe every student deserves a mentor growing up. They’d know their strengths, understand their options, and make decisions with confidence—not out of comparison, pressure, or fear of missing out.</p> */}
            <p className='text-base md:text-lg text-[#8B0000]'>At <strong>(un)<span className='text-[#1f2225] font-bold'>certain</span></strong>, we believe every student deserves a mentor growing up. They’d know their strengths, understand their options, and make decisions with confidence—not out of comparison, pressure, or fear of missing out.</p>
