  ...
  return (
    <div className='w-full'>
      ...
      <div className='min-h-[60vh] md:min-h-[70vh] w-full flex items-center justify-center p-4 sm:p-8'>
        <h1 className='text-center max-w-4xl text-4xl md:text-6xl lg:text-7xl leading-tight lg:leading-snug'>We started <br /> <span className='text-red-600'>(un)</span>certain <br /> because we've <br /> been there</h1>
      </div>
    </div>
  );
}
